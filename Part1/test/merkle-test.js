...
describe("MerkleTree", function () {
    ...
    it("Insert two new leaves and verify the first leaf in an inclusion proof", async function () {
        ...
        const fullProve = await groth16.fullProve(Input2, "circuits/circuit_js/circuit.wasm","circuits/circuit_final.zkey");
        const proof2 = fullProve.proof;
        const publicSignals2 = fullProve.publicSignals;
